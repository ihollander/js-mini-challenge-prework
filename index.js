...
// I'm submitting the above because of the wording of the question, but here is an
// alternate solution demonstrating my understanding of "==":
...
function takeATicketNumber(line) {
  ...
  lineCounter++
  return `Welcome. You are ticket number ${lineCounter-1}`
}
