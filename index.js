...
function printNameAndPhones(users) {
  ...
  console.log(`Cell: ${users[0].phones.cell}`)
  console.log(`Office: ${users[0].phones.office}`)
  console.log(users[1].name)
  console.log(`Cell: ${users[1].phones.cell}`)
  console.log(`Office: ${users[1].phones.office}`)
...
function takeATicketNumber(line, ticket) {
  line.push(ticket)
